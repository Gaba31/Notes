...
-- By this it will make two buckets
-- one with stock quanity >= 50 and price >=200
-- other bucket which not fullfil this requirement
-- That's why without desc it will come at an end 
-- because the value for that will assigned 1 and for the rest 0
-- and in asc ordering 0 will come prior to 1
SELECT *, 
