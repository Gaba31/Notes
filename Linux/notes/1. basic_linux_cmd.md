...
### Basic Editing in nano / Terminal:
...
## 22. `alias`
Explaination : For shorten our command  or a file which we want to execute with a short form , we use alias and add it in .bashrc file.